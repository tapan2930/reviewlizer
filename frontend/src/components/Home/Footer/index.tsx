    ...
    return (
        ...
        <div className="bg-gray-800 py-6 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="container">
            <div className="flex items-center ml-3 md:ml-0"> {/* logo container */ }
                <img className="w-12" src="/assets/images/logo.color.png" alt="logo"/>
                <h1 className="uppercase ml-2 font-semibold text-white">Reviewlizer</h1>
            </div>
          </div>

         {/* Right Side */}
          <div className="grid grid-cols-3 container px-3 text-white my-auto">
            <div>
